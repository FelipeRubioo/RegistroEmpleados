...
<body onload="activarSelects()">
                    ...
                    <div class="row">
                        ...
                        <script>
                            function mostrarPreview() {
                                ...
                                // asegura que el archivo este seleccionado
                        ...
                        <div class="col-md-4 mt-3">
                            ...
                            <input type="file" class="form-control-file mt-2" name="fotografia" id="fotografia" accept="image/*" onchange="mostrarPreview()">
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        if (
            ...
            //si se agregaron tres elementos studyContainer1, studyContainer2, studyContainer3 y eliminamos el primero
            //tendremos que studyCount = 2 y tenemos los contenedores 2 y 3
            //asi que el loop se hará dos veces, no alcanzará a pasar el contenedor 3,
            //el +1 solo es importante por ese caso, si se elimina el primer estudio.
            for ($i = 1; $i <= $studyCount + 1; $i++) {
                ...
                //solo se agrega al arreglo de estudios los que no tengan campos vacios
                if ($escuela != null && $gradoDeEstudios != null && $fechaInicio != null && $fechaFin != null)
